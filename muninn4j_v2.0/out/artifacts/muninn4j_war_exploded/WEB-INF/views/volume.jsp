...
<nav class="nav nav-tabs bg-light">
    <li class="nav-item">
        <small><a class="nav-link">${volume.title}</a></small>
    </li>
    <li class="nav-item">
...
<div class="container mt-5 ml-auto">
    <div class="row">
        ...
        <div class="col-md-8 pl-3">
            <!--本章概览-->
            <div class="card">
                <div class="card-header">${requestScope.volume.title} - 课程简介</div>
                <div class="card-body">
                    ${volume.intro}
                    <p class="card-text">
                        <small class="text-muted">更新于 2018 年 <a href="#" target="_black" class="card-link">查看笔记</a></small>
                    </p>
                </div>
            </div>
            <!--笔记详情-->
